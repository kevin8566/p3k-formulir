...
export default function FormPengajuan() {
    ...
    const renderStep = () => {
        ...
        switch (step) {
            ...
            case 4:
                return <Step4DataPegawaiPendapatan {...props} />;
            case 5:
                return <Step5PengajuanKredit {...props} />;
            case 6:
                return <Step6UploadBerkas {...props} />;
            default:
                return null;
        }
    };
                            ...
                            {isSuccess ? (
                                ...
                                >
                                    ...
                                    <p className="text-gray-500 max-w-sm font-medium mb-10">
                                        Terima kasih. Data Anda sedang diproses
                                        oleh sistem perbankan kami.
                                    </p>
