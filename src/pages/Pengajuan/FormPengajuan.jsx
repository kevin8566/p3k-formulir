...
const INITIAL_FORM_DATA = {
    ...
    // REVISI: Mengganti 3 syarat lama menjadi 1 syarat pernyataan komprehensif
...
export default function FormPengajuan() {
    ...
    const renderStep = () => {
        ...
        switch (step) {
            case 1:
                return <Step1DataDiri {...props} />;
            case 2:
                return <Step2DataSuamiIstri {...props} />;
            case 3:
                return <Step3DataOrangTerdekat {...props} />;
            case 4:
                return <Step4DataPegawai {...props} />;
            // case 5: return <Step5Pendapatan {...props} />;
            case 5:
                return <Step6PengajuanKredit {...props} />;
            case 6:
                return <Step7UploadBerkas {...props} />;
            default:
                return null;
        }
    };

    // REVISI: Logika pengunci tombol Kirim sekarang hanya mengecek variabel setuju_pernyataan
                    ...
                    <div className="relative flex justify-between items-center w-full">
                        ...
                        {STEPS_LABEL.map((label, idx) => (
                            ...
                            >
                                ...
                                <span
                                    className={`text-[9px] md:text-[10px] font-bold uppercase tracking-tight text-center hidden sm:block ${step >= idx + 1 ? "text-[#0B1171]" : "text-gray-400"}`}
                                >
                                    {label}
                                </span>
                            </div>
                    ...
                    <AnimatePresence mode="wait">
                        {isSuccess ? (
                            ...
                            >
                                ...
                                <h3 className="text-3xl font-black text-[#0B1171] mb-2 uppercase">
                                    Pengajuan Terkirim!
                                </h3>
                                <p className="text-gray-500 max-w-sm font-medium mb-10">
                                    Terima kasih. Data Anda sedang diproses oleh
                                    sistem perbankan kami.
                                </p>
                                ...
                                <motion.a
                                    ...
                                    className="px-8 py-4 bg-[#0B1171] text-white rounded-xl font-bold uppercase tracking-widest shadow-xl shadow-blue-900/20 hover:bg-[#070b4a] hover:-translate-y-1 transition-all flex items-center gap-2"
                                >
                                    <svg
                            ...
                            >
                                ...
                                <div className="mt-16 pt-8 border-t border-gray-100 flex justify-between items-center">
                                    <button
                                        ...
                                        className={`font-bold text-[#0B1171] flex items-center gap-2 ${step === 1 ? "opacity-0 invisible" : ""}`}
                                    >
                                        ❮ Sebelumnya
                                    </button>
                                    ...
                                    {step === 6 ? (
                                        <motion.button
                                            ...
                                            animate={{
                                                width: isSubmitting ? 56 : 240,
                                                borderRadius: isSubmitting
                                                    ? 28
                                                    : 12,
                                            }}
                                        ...
                                        <button
                                            onClick={handleNext}
                                            className="bg-[#0B1171] text-white px-10 py-4 rounded-xl font-black uppercase tracking-widest shadow-xl shadow-blue-900/20 active:scale-95 transition-all"
                                        >
                                            Selanjutnya ❯
                                        </button>
                                    )}
