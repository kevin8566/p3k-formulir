        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div>
                <div className="flex items-center gap-4 mb-8">
                    <h3 className="text-lg font-bold text-[#0B1171] whitespace-nowrap">Informasi Kepegawaian</h3>
            ...
            <div className="pt-2">
                <div className="flex items-center gap-4 mb-8">
                    <h3 className="text-lg font-bold text-[#0B1171] whitespace-nowrap">Informasi Pendapatan</h3>
