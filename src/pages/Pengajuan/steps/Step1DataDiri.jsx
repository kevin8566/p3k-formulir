                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="flex flex-col gap-2">
                            ...
                            <input
                                type="number" name="kode_pos" value={formData.kode_pos || ''} onChange={handleChange}
                                placeholder="57xxx"
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-bold text-[#0B1171]">Email</label>
                            <input
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-bold text-[#0B1171]">Nomor Telepon / WA</label>
                            <input
                                type="tel" name="no_telp" value={formData.no_telp || ''} onChange={handleChange}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="flex flex-col gap-2">
                            ...
                            <select
                                name="jenis_kelamin" value={formData.jenis_kelamin || ''} onChange={handleChange}
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input
                                type="number" name="nik" value={formData.nik || ''} onChange={handleChange}
            ...
            <div className="pt-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex flex-col gap-2">
                        ...
                        <select
                            name="status_rumah" value={formData.status_rumah || ''} onChange={handleChange}
                            className="w-full border border-gray-200 rounded-lg px-4 py-3.5 focus:border-[#0B1171] focus:ring-1 focus:ring-[#0B1171] outline-none text-gray-500 text-sm bg-white transition-all"
                        >
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <select
                            name="status_pernikahan" value={formData.status_pernikahan || ''} onChange={handleChange}
                            className="w-full border border-gray-200 rounded-lg px-4 py-3.5 focus:border-[#0B1171] focus:ring-1 focus:ring-[#0B1171] outline-none text-gray-500 text-sm bg-white transition-all"
                        >
                            <option value="">Pilih status</option>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input
                            type="text" name="npwp" value={formData.npwp || ''} onChange={handleChange}
